...
import { getProducts, addToCart, getCart, getUserInfo } from '../apiAxios';
              ...
              return (
                ...
                >
                  <img
                    ...
                    alt={product.name}
                    className="w-32 h-32 object-contain rounded-md float-right ml-4 mb-2" // Image in top-right
                  />
                    ...
                    {userRole !== 'community' && (
                      <button
                        ...
                        className={`mt-4 w-full p-2 rounded text-white ${
                          loading || !isQuantityValid ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'
